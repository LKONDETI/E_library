...
const CardList = () => {
  ...
  return (
    <div>
      <div><NavSideBars/></div>
      <div class="p-3 text-center bg-light border border-dark" style={{marginTop:'0px',marginLeft:'210px', paddingBottom:'30px', width:'150vh'}}>
      ...
      <div class="d-flex gap-4 row row-cols-4" style={{marginLeft:'200px', marginTop:'20px'}}>
        {filteredCards.map(card => (<div class="border border-dark text-white" style={{backgroundColor: '#0c1524', width:'20rem', borderRadius:'10px'}}>
          <div key={card.id}>
            ...
            <img src={card.Image} style={{width:'8rem', float:'right', marginTop:'0px'}} />
